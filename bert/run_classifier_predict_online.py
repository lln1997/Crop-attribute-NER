...
## Required parameters
BERT_BASE_DIR = 'weight/chinese_L-12_H-768_A-12/'
...
class SentencePairClassificationProcessor(DataProcessor):
    """Processor for the internal data1 set. sentence pair classification"""
...
def predict_online(line):
    ...
    """
    label = line[
        0]  # tokenization.convert_to_unicode(line[0]) # this should compatible with format you defined in processor.
