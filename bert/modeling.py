...
# See theF License for the specific language governing permissions and
...
def transformer_model(input_tensor,
  ...
  Also see:
  https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/model/transformer.py
